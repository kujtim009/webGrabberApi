...
fetch_company_dir = fetch_request('https://www.linkedin.com/company/revature/about/')
if fetch_company_dir:
    ...
    print('--------------------------')
    print(sub_pages)
    print("Status:", fetch_company_dir.status_code)
    print("Content:", fetch_company_dir.content)
    if sub_pages:
